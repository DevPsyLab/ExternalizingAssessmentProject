...
If the measure has a name for a given scale or subscale, use these names, but follow the standard measure table naming convention (e.g., Rule Breaking Behavior = ruleBreakingBehavior). If measure does not have a clear name, use naming convention to label with 1-3 words best describing the scale or subscale.
