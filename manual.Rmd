...
This stage involves filling out the `Measures` tab of the `Existing Measures and Items` spreadsheet and adding instruments to the `Instruments` folder.
...
Add instruments to the `Instruments` folder, located [here](https://drive.google.com/drive/u/0/folders/1UL9_9tbKPQeKNLftlBTdWI9kVcqEn51f).
