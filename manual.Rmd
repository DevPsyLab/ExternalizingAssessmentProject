...
- `instrumentPDF`: whether or not we have the PDF of the instrument (indicate yes with an `x`); if not, say why not
- `sourceRefPDF`: whether or not we have the PDF of the source reference (indicate yes with an `x`); if not, say why not
