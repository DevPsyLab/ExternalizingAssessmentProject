...
- `instrumentPDF`: whether or not we have the PDF of the instrument (indicate yes with an `x`); if we are unable to obtain it, specify why not
- `sourceRefPDF`: whether or not we have the PDF of the source reference (indicate yes with an `x`); if we are unable to obtain it, specify why not
### How Rows are Sorted
